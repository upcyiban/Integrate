...
public class FoodArticleController {
    ...
    public Object browseFood(int pagesize,int page){
    ...
    public Object titleSearch(String Authorization,String kind,int page,int pagesize){
        return foodArticleService.titleSearch(kind,pagesize,page);
    }

    @ApiOperation("菜品名称搜索，分页参数")
    @ApiImplicitParams({
            @ApiImplicitParam(name = SwaggerParameter.Authorization, value = "token", dataType ="String",paramType = "query"),
    ...
    public Object nameSearch(String Authorization,String name,int page,int pagesize){
        return foodArticleService.nameSearch(name,pagesize,page);
    }
}
