...
public class Teacher {
    ...
    public Teacher(String name, String imgurl, String profile, String motto, String QRcode, int yibanId, String recommend, String phonenumber, String email) {
        this.name = name;
        this.imgurl = imgurl;
        this.profile = profile;
        this.motto = motto;
